...
class SR_Dataset_4(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        poss_targets = [image_t1, image_t2, image_t3, image_t4] 
        mediana = [image_t1.mean(), image_t2.mean(), image_t3.mean(), image_t4.mean()] 
...
class ToTensor(object):
    ...
    def __call__(self, samples, t):
        image_t1, image_t2, image_t3, image_t4, target = samples['image_1'], samples['image_2'], samples['image_3'], samples['image_4'], t['target']

        # torch image: C X H X W

        samples = {'image_1': torch.from_numpy(image_t1), 'image_2': torch.from_numpy(image_t2), 'image_3': torch.from_numpy(image_t3), 'image_4': torch.from_numpy(image_t4)}
