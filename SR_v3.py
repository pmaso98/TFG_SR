...
class SR(nn.Module):
    def __init__(self):
        ...
        self.instancenorm1 = nn.InstanceNorm2d(64, affine=True)  # affine=True --> Learnable parameters
        ...
        self.instancenorm3 = nn.InstanceNorm2d(4, affine=True)
    ...
    def forward(self, image_t1, image_t2, image_t3, image_t4,
        ...
        print(input.shape)
        print(input[1].__len__())

        images_SISRNET = []

        # SISRNET

        for i in range(input[1].__len__()): # SISRNET INDIVIDUAL POR IMAGEN
